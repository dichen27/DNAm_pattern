...
######## load data
select_cluster<-c(1,3:9,11,12);# select brain 10 clusters
...
## r-matrix ME
r_ME_all<-matrix(data = NA, nrow = 3, ncol = 10)
p_ME_all<-matrix(data = NA, nrow = 3, ncol = 10)
for (i in 1:3){
  i
for (j in 1:10){
...
print(fMRI_type[k])
result_dir<-paste0("./Result_CCA_brain_cluster10/result_CCA_change_Methy_",fMRI_type[k],".mat")
...
##################### save component
save_component_dir<-paste0("./Result_CCA_brain_cluster10/Component_",fMRI_type[k],".mat")
...
##################### save
save_dir<-paste0("./Result_CCA_brain_cluster10/result_CCA_change_Methy_",fMRI_type[k],".mat")
