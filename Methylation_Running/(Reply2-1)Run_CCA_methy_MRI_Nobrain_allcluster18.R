...
######## load data
select_cluster<-c(1:18)# select brain 8 clusters
...
print(fMRI_type[k])
result_dir<-paste0("./Result_CCA_all_cluster18/result_CCA_change_Methy_",fMRI_type[k],".mat")
...
##################### save component
save_component_dir<-paste0("./Result_CCA_all_cluster18/Component_",fMRI_type[k],".mat")
...
##################### save
save_dir<-paste0("./Result_CCA_all_cluster18/result_CCA_change_Methy_",fMRI_type[k],".mat")
