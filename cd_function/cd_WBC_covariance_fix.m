function Covariance=cd_WBC_covariance_fix(VDI,t_12,N_1,N_2,h_1,h_2,intercept_1,intercept_2,N_s,phenotype_r)
...
y=t_12-ones(length(VDI),1)*phenotype_r;
X=VDI;
% X=[ones(length(x),1),x];
...
var_2=((Q_g_foundation*sqrt(N_1*N_2)*VDI(i))/M)+phenotype_r;
end
