function [p, Q]=cd_chi2test_improve(gender_a,gender_d)

% [324, 556-324; 98, 260-98]

x=[sum(gender_a),length(gender_a)-sum(gender_a);sum(gender_d),length(gender_d)-sum(gender_d)];
