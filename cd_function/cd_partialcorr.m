...
function [r,p,df,n]=cd_partialcorr(PRS_mean_ID,SDQ_total_4groups,cov_GWAS)
...
[r,p]=partialcorr(PRS_mean_intersect(:,2:end),SDQ_intersect(:,2:end),cov_intersect(:,2:end));
